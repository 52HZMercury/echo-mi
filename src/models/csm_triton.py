...
WITH_TRITON = os.environ.get("XFMAMBA_USE_TRITON", "0") == "1"
if WITH_TRITON:
    try:
        import triton
        ...
        WITH_TRITON = False
        warnings.warn("Triton unavailable, fall back to PyTorch implementations.")
...
if not WITH_TRITON:
    ...
    class _TritonLanguageFallback:
        tensor = torch.Tensor
        constexpr = object

    triton = _TritonFallback()
    tl = _TritonLanguageFallback()
