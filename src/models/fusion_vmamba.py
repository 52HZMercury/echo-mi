...
class ShallowFusionBlock_v4(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        x1_shallowfuse, x2_shallowfuse = self.shallowfuseSS2D(x1_perm, x2_perm)
        x1_shallowfuse = self.drop_path(x1_shallowfuse)
        x2_shallowfuse = self.drop_path(x2_shallowfuse)
