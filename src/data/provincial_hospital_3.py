...
class ProvincialHospital3Dataset(BaseEchoDataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.view == "2C":
            ...
            label = int(patient_info["severity"])
            # 返回样本ID
...
class ProvincialHospitalDataModule(BaseDataModule):
    ...
    def setup(self, stage=None):
        self.train_dataset = ProvincialHospital3Dataset(self.data_dir, self.metadata_path, "train", self.fold, self.view)
        self.val_dataset = ProvincialHospital3Dataset(self.data_dir, self.metadata_path, "test", self.fold, self.view)
